...
RELEASE_CXXFLAGS=-O3 -flto -march=native -mtune=native -static-libstdc++ -Wall -Wextra -Wconversion -Wsign-conversion -Wlogical-op -Wshadow -pedantic -Werror -std=c++11
