...
CXXFLAGS=-g -O0 -Wall -Wextra -Wconversion -Wsign-conversion -Wlogical-op -Wshadow -pedantic -Werror -std=c++11 -I/usr/local/include -include mimalloc-new-delete.h
RELEASE_CXXFLAGS=-g0 -O3 -flto=auto -fuse-linker-plugin -march=native -static-libstdc++ -fPIC -fstack-protector-strong -Wall -Wextra -Wconversion -Wsign-conversion -Wlogical-op -Wshadow -pedantic -Werror -std=c++11 -I/usr/local/include -include mimalloc-new-delete.h
