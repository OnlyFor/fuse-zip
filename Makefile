...
RELEASE_CXXFLAGS=-g0 -O3 -flto=auto -march=native -mtune=native -static-libstdc++ -fPIC -fstack-protector-strong -Wall -Wextra -Wconversion -Wsign-conversion -Wlogical-op -Wshadow -pedantic -Werror -std=c++11
