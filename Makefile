...
RELEASE_CXXFLAGS=-Ofast -march=native -mtune=native -funroll-loops -static-libstdc++ -Wall -Wextra -Wconversion -Wsign-conversion -Wlogical-op -Wshadow -pedantic -Werror -std=c++11
