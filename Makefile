...
RELEASE_CXXFLAGS=-g0 -O3 -flto=auto -march=native -mtune=native -pthread -static -static-libgcc -static-libstdc++ -I/usr/include -L/usr/local/lib -L/lib/x86_64-linux-gnu -L/usr/lib/x86_64-linux-gnu -fPIC -Wall -Wextra -Wconversion -Wsign-conversion -Wlogical-op -Wshadow -pedantic -Werror -std=c++11
